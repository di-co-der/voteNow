    ...
    return (
        <div className="mx-auto max-w-screen-lg [&_a]:text-primary-600 [&_a]:underline space-y-8  px-3 py-8 text-justify text-sm md:py-12 md:text-left md:text-base [&>div]:space-y-2.5 ">
            <div className="card">
                ...
                <p>
                    Welcome to voteNow, your go-to destination for an engaging and interactive voting experience
                    during the 2024 Lok Sabha Elections!
                </p>

                <p>
                    At voteNow, we believe that every voice matters in shaping the future of our nation. That's why
                ...
                <p>
                    ...
                    participant, voteNow provides a convenient way to simulate the voting process and view real-time
                    results.
                </p>

                <p>
                    One of the highlights of voteNow is the integration of React Chart, allowing users to explore
                    voting trends through dynamic and interactive visualizations. Witness the pulse of democracy unfold
                    right before your eyes!
                </p>

                <p>
                    But voteNow isn't just about voting. It's also a learning experience. As the creator of voteNow,
            ...
            <div className="card">
                ...
                <ol className="mt-4 list-disc space-y-3 pl-4 text-sm ">
                    <li>
                        <b>Usage:</b> voteNow is intended for educational and informational purposes only. Users are
                        prohibited from engaging in any unlawful or malicious activities on the platform.
                    </li>

                    <li>
                        <b>Accuracy:</b> While we strive to provide accurate and up-to-date information, voteNow
                    ...
                    <li>
                        ...
                        personal information. voteNow adheres to strict data privacy policies and does not share user
                    ...
                    <li>
                        ...
                        concerns about voteNow, please don't hesitate to reach out to us.
                    </li>
                </ol>
            </div>
            ...
            <div className="card">
                ...
                <p>
                    ...
                    <a className="" href="mailto:admin@voteNow.site">
                        admin@voteNow.site
                    </a>{' '}
                    . We welcome your inquiries and feedback! Thank you for choosing voteNow.{' '}
                </p>
            </div>
        </div>
    );
